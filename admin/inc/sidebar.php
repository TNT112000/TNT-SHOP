<div class="content">
    <div class="sidebar ">
        <div class="flex-shrink-0 p-3">
            <a class="title_sidebar d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
                <i class="fa-solid fa-house"></i>
                <span class="fs-5 fw-semibold">DANH MỤC QUẢN LÝ</span>
            </a>
            <ul class="list-unstyled ps-0 list_category_admin">
